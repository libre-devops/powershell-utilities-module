#
# Module manifest for module 'LibreDevOpsHelpers.PowerShell'
#
...
# Script module or binary module file associated with this manifest.
    RootModule = 'LibreDevOpsHelpers.PowerShell.psm1'
    ...
    GUID = 'c8839f8a-06ac-4fef-94b3-3e5063b5fe32'
    ...
    Description = 'PowerShell helper functions for LibreDevOps'
    ...
    #RequiredModules = @("Az.KeyVault" "Az.Network" "Az.Accounts" "Az.Storage")
    ...
    PrivateData = @{
        ...
        # Tags applied to this module. These help with module discovery in online galleries.
            Tags = @("azure" "powershell" "terraform" "libre-devops")
